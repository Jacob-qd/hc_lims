...
export const mockAIAlerts: AIAlert[] = [
  ...
  },
  {
    ...
    resolvedAt: '2026-05-15 09:30:00',
  },
  {
    id: 'alt5',
    type: 'instrument',
...
export const mockAIReplyTemplates: Record<string, { content: string; type: 'text' | 'table'; data?: any[] }> = {
  ...
  '客户': {
    ...
    type: 'table',
    data: [
      { customer: '绿源环保科技有限公司', samples: 58, amount: '¥42,000' },
      { customer: '市政水务集团', samples: 45, amount: '¥38,500' },
      { customer: '清源化工有限公司', samples: 32, amount: '¥28,000' },
      { customer: '蓝天环境监测站', samples: 28, amount: '¥22,000' },
      { customer: '宏达食品有限公司', samples: 22, amount: '¥18,500' },
    ],
  },
  '报告': {
    content: '本月报告出具情况：已出具 **198** 份，待审核 **12** 份，待签发 **5** 份。平均出具周期 **2.8** 天，较上月缩短 0.4 天。',
    type: 'text',
  },
  '趋势': {
    content: '近 30 天检测量呈上升趋势，日均检测量从 7.2 批次增至 9.5 批次（+32%）。建议关注人员排班和仪器负载。',
    type: 'text',
  },
};
