...
export const mockTasks: TaskItem[] = [
  ...
  { id: 'tk3', taskNo: 'TK-2025-003', sampleId: 's2', sampleNo: 'SMP20240520002', sampleName: '饮用水样品-2', testItem: '氨氮', method: 'HJ 535-2009', analystId: 'a3', analystName: '李明', instrumentId: 'i5', instrumentName: '紫外分光光度计 UV-001', labId: 'l2', labName: '理化实验室', plannedStart: '2024-05-20', plannedEnd: '2024-05-23', priority: 'normal', priorityLabel: '中', status: 'pending', statusLabel: '待检测', progress: 0, createdAt: '2024-05-20', updatedAt: '2024-05-20', customerName: '博克水务', projectName: '饮用水检测' },
  { id: 'tk4', taskNo: 'TK-2025-004', sampleId: 's3', sampleNo: 'SMP20240520045', sampleName: '土壤样品-3', testItem: '重金属(Pb)', method: 'GB/T 17141-1997', analystId: 'a6', analystName: '郑丽', instrumentId: 'i3', instrumentName: '原子吸收光谱仪 AAS-001', labId: 'l3', labName: '无机分析室', plannedStart: '2024-05-21', plannedEnd: '2024-05-23', actualStart: '2024-05-21', priority: 'normal', priorityLabel: '常规', status: 'pending_review', statusLabel: '待审核', progress: 90, createdAt: '2024-05-20', updatedAt: '2024-05-22', customerName: '红创检测', projectName: '土壤检测' },
