...
export const TaskResultEntry: React.FC = () => {
  ...
  const columns = [
    ...
    { title: '检测结果', dataIndex: 'result', key: 'result', width: 100, render: (v: string, r: Record<string, LooseAny>) => (
    ...
    { title: '备注', dataIndex: 'note', key: 'note', width: 120, render: (v: string, r: Record<string, LooseAny>) => (
