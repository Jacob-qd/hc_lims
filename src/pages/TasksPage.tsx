...
export const TasksPage: React.FC = () => {
  ...
  const columns: ColumnsType<TaskItem> = [
    ...
    { title: '操作', key: 'action', width: 160, render: (_: string, r: TaskItem) => (
      <Space>
  ...
  return (
    <div>
      ...
      <Drawer title={selectedTask?.taskNo} open={drawerVisible} onClose={() => { setDrawerVisible(false); setSelectedTask(null); }} width={480}>
        {selectedTask && (
          <>
