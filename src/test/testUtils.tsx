 ...
 *   });
 */
export function setupMockApi(routes: LooseAny) {
  return vi.spyOn(globalThis as LooseAny as { fetch: typeof globalThis.fetch }, 'fetch').mockImplementation(async (input: LooseAny) => {
...
export function mockFetch(data: LooseAny, ok = true) {
  return vi.spyOn(globalThis as LooseAny as { fetch: typeof globalThis.fetch }, 'fetch').mockResolvedValue({
...
export function buildReport(overrides?: Partial<Record<string, LooseAny>>): Record<string, LooseAny> {
  return {
    id: uid('r'),
...
export function buildSample(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('s'),
...
export function buildTask(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('t'),
...
export function buildCOCChain(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('coc'),
...
export function buildCertificate(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('cert'),
    userName: '张三',
...
export function buildBackup(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('bkp'),
...
export function buildMethod(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('mtd'),
...
export function buildELNEntry(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('eln'),
    title: '实验记录',
    author: '张三',
...
export function buildWorkflowDef(overrides?: Record<string, LooseAny>): Record<string, LooseAny> {
  return {
    id: uid('wf'),
    name: '审批流程',
    type: '审批',
